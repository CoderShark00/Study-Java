...
/*
    1. 빌더 패턴(Builder Pattern)이란?
        빌더 패턴은 객체의 생성 과정에서 '복잡한 생성자'를 대신하여 객체를 단꼐적으로 생성할 수 있도록
        도와주는 디자인 패턴. GOF(Gang of Four) 디자인 패턴 중 하나로, 객체 생성
        제공하는 것이 목표

        주요 특징 :
            1) 객체를 생성하는 여러개의 필드를 명시적으로 관리할 수 있음.
...
public class PersonMain {
    public static void main(String[] args) {
        // Person.java에서 정의한 Builder Pattern을 이용하여 객체를 생성하는 방법
         ...
         Person person1 = new Person.Builder("안근수")
                .build();
